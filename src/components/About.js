...
const About = () => {
  return (
    <Tilt tiltMaxAngleX={2} tiltMaxAngleY={2}>
      <div className=" flex relative mx-10 text-[#C0BAC3] bg-cover my-10 rounded-xl bg-[url('/src/assets/images/bg1.png')] font-['impact']">
        <div className="w-[60%]">
          ...
          <p className="pt-[12vw] pl-[4.8rem] font-['Helvetica']">
            ...
            fashion. I would personaly make sure that everythig runs smooth with
